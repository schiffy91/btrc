...
STDLIB_STATIC_METHODS: dict[str, list[BuiltinMember]] = {
    ...
    "DaemonControlProtocol": [
        BuiltinMember("pauseBeforeRetry", "bool", "method", [("long long", "deadline")], "pauseBeforeRetry"),
    ...
    "UnixFileSystem": [
        ...
        BuiltinMember("leaseDirectoryAt", "DirectoryLease", "method", [("int", "parentDescriptor"), ("string", "name")], "leaseDirectoryAt"),
        BuiltinMember("removeRecursiveAtLease", "int", "method", [("int", "parentDescriptor"), ("string", "name"), ("DirectoryLease", "lease")], "removeRecursiveAtLease"),
