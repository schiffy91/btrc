...
from src.devex.lsp.utils import find_closing_brace_line, find_enclosing_class_from_source
...
"""
    ...
    assert find_enclosing_class_from_source(ast, source, 3) == "A"
    assert find_closing_brace_line(source.splitlines(), 0) == 4
