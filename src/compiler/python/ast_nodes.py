...
@dataclass
class PropertyDecl:
    access: str = "public"                        # "public" | "private"
    type: TypeExpr = None
    name: str = ""
    has_getter: bool = False
    has_setter: bool = False
    getter_body: Optional[Block] = None           # None = auto-property getter
    setter_body: Optional[Block] = None           # None = auto-property setter
    line: int = 0
    col: int = 0
...
class ForInStmt:
    var_name: str = ""
    var_name2: str = ""  # Second variable for Map iteration: for k, v in map
