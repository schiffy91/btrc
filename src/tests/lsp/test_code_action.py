...
def test_levenshtein_basic():
    assert CODE_ACTIONS._levenshtein("Widget", "Widget", 2) == 0
    assert CODE_ACTIONS._levenshtein("Widgt", "Widget", 2) == 1
    assert CODE_ACTIONS._levenshtein("xyz", "Widget", 2) == 3  # capped
    assert CODE_ACTIONS._closest("Widgt", ["Widget", "Gadget"]) == "Widget"
    assert CODE_ACTIONS._closest("zzzzzz", ["Widget"]) is None  # too far
