...
from src.compiler.python.syntax.ast.generated import ClassDecl, StructDecl
from src.devex.lsp.workspace import cache as unit_cache
from src.devex.lsp.workspace import units
from src.devex.lsp.workspace import workspace as workspace_module
from src.devex.lsp.workspace.cache import FileUnitCacheCodec, UnitCache
...
def test_cache_and_workspace_behavior_is_instance_owned() -> None:
    ...
    for filename in ("cache.py", "units.py", "workspace.py"):
