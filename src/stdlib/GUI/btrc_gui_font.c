...
static void font_draw(BtrcGuiPixels* sv, void* fontv, int x, int y, const char* text, uint32_t rgba, GuiBlendPixel blend) {
...
static int font_width(void* fontv, const char* text) {
    btrc_font* f = (btrc_font*)fontv;
    if (!f || !text) { return 0; }
    int64_t width = 0;
    int64_t max_width = 0;
