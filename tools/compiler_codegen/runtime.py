...
class RuntimeCatalogGenerator:
    ...
    def _render_btrc(self) -> str:
        lines = [
            ...
            "    public string name;",
            "    public Vector<string> sourceChunks;",
            "    public Vector<string> dependencies;",
            "    public Vector<string> headers;",
            "    public Vector<string> providedTypes;",
            "    public Vector<string> providedObjects;",
            ...
            "            string category,",
            "            string name,",
            "            Vector<string> sourceChunks,",
            "            Vector<string> dependencies,",
            "            Vector<string> headers,",
            "            Vector<string> providedTypes,",
            "            Vector<string> providedObjects,",
            "            bool sourceVisible,",
            ...
            "        self.providedTypes = providedTypes;",
            "        self.providedObjects = providedObjects;",
            ...
            "            string receiver, string method, string realtimeEffect,",
            "            string cCallee, string provenance) {",
            "        self.receiver = receiver;",
            "        self.method = method;",
            "        self.realtimeEffect = realtimeEffect;",
            "        self.cCallee = cCallee;",
            ...
            "    public Vector<GeneratedIntrinsicEffectRow> intrinsicEffects;",
            "",
        ...
        for start in range(0, len(blocks), self.BTRC_ROWS_PER_METHOD):
            ...
            methods.extend(["    }", ""])
        lines.append("        self.intrinsicEffects = [];")
        for method in self._intrinsic_effects.methods:
            lines.append(
